...
The hours question in time-box mode is a good example of one to make clickable: offer plausible
brackets plus an "Other" for an exact number, rather than asking them to compute and type it.
